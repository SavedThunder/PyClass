...
#Can Edit Twitter Name for different Users
TWITTER_NAME = "chancetherapper"
TWEET_WINDOW = True
FOLLOWERS = []
try:
			...
			for follower in Followers:
				if follower.id not in FOLLOWERS:
					if rateLimitNotExceeded():
						...
						API.create_friendship(follwer.id)
